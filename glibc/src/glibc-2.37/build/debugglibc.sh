...
SOURCE_DIR="/sources/glibc/src/glibc-2.37"
BUILD_DIR="/sources/glibc/src/glibc-2.37/build/"
CMD_FILE="/sources/glibc/src/glibc-2.37/build/debugglibc.gdb"
CONTAINER=false
DIRECT=true
STATIC=false
SYMBOLSFILE=true
...
WAIT_FOR_DEBUGGER=1 /sources/glibc/src/glibc-2.37/build/testrun.sh --tool=container ${TESTCASE} &
gdb -x ${TESTCASE}.gdb
elif [ "$STATIC" == true ]
then
gdb ${TESTCASE}
